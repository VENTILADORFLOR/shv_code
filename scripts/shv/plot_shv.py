...
required_cols = [
    "date", "SOL_raw", "SOL", "STL_Trend",
    "STL_Seasonal", "STL_Resid", "YoY_pct", "Index_2017",
    "is_cloud_gap", "is_low_cvg", "SOL_interp",
]
missing_cols = [c for c in required_cols if c not in df.columns]
if missing_cols:
    raise ValueError(
        f"Input CSV is missing required columns: {missing_cols}\n"
        "Please run analyze_shv.py first to generate the complete statistics file."
    )
...
# Marker position: leave space at the bottom of the plot
...
# =========================================================
# 4. Figure 1: main panel (raw SOL + index + YoY)
# =========================================================
...
ax1.set_title(
    "Sihanoukville Province — Total Sum of Lights 2014–2026\n"
    "VIIRS monthly · Sea-surface excluded (MOD44W) · STL decomposition",
...
panels = [
    (df["SOL"],          "#2E86C1", "Original SOL Sum (missing and low-quality values linearly interpolated)"),
...
fig2.suptitle(
    "STL Decomposition — Sihanoukville Province Total SOL\n"
    "Sea-surface excluded (MOD44W) · Low-cvg months interpolated · robust=True",
